...
# include "clong/find-all-symbols/FindAllSymbolsAction.h"
# include "clong/find-all-symbols/STLPostfixHeaderMap.h"
# include "clong/find-all-symbols/SymbolInfo.h"
# include "clong/find-all-symbols/SymbolReporter.h"
