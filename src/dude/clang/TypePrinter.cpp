...
//       said this way: so that you can benefit from their code !
//
//===----------------------------------------------------------------------===//

#if 0 // FABIC: Moved to header file TypePrinter.hpp
...
#if 0 // FABIC --> See TypePrinter.hpp
...
} // FABIC: end of the anonymous global ns.
#endif //0 FABIC
