    ...
    Clong::InitPostgresDatabase()
    {
      ...
      *log << "- Creating table " << twhite << "decl_kind" << tnormal << tendl;
      ...
      PQXX_.TXN().exec(R"(
        ...
        DROP TABLE IF EXISTS decl_kind ;
      )");
      ...
      PQXX_.TXN().exec(R"(
        ...
        (
          ...
          id       INT PRIMARY KEY NOT NULL
                       GENERATED BY DEFAULT AS IDENTITY (START 1000),

          kind             SMALLINT NOT NULL REFERENCES decl_kind (id),
          context_id       INT NULL REFERENCES decl (id),

          cvr              SMALLINT DEFAULT 0,
          type_id          INT NULL REFERENCES decl (id),
